...
- [ ] A. It provides a serverless execution environment.
- [x] B. It provides virtual machines (servers) in the cloud.
- [ ] C. It hosts containerized applications exclusively.
- [ ] D. It provides a fully managed platform as a service.
...
- [ ] B. Subnets and VPC configurations.
- [x] C. A template for the root volume, launch permissions, and block device mappings.
- [ ] D. Load balancers and Auto Scaling groups.
...
- [ ] A. They automatically secure the network traffic.
- [x] B. They provide repeatability by allowing you to launch instances with efficiency and precision repeatedly.
- [ ] C. They reduce the cost of Amazon EBS volumes.
- [ ] D. They automatically scale your application.
...
- [ ] A. An instance store-backed instance boots faster.
- [x] B. An EBS-backed instance can be placed in a stopped state, whereas an instance store-backed instance cannot.
- [ ] C. An instance store-backed instance allows changing the instance type.
- [ ] D. An EBS-backed instance has a maximum root device size of 10 GiB.
...
- [ ] A. General purpose instance types
- [ ] B. Compute optimized instance types
- [x] C. Storage optimized instance types
...
- [x] C. Throughput Optimized HDD (st1)
- [ ] D. Cold HDD (sc1)
...
- [ ] B. Amazon EBS
- [ ] C. Amazon S3
- [x] D. Amazon FSx for Windows File Server
...
- [ ] A. By querying instance metadata
- [x] B. By specifying user data
- [ ] C. By deploying a Golden AMI
- [ ] D. By attaching an Amazon EFS volume
...
- [x] A. http://169.254.169.254/latest/meta-data/
- [ ] B. http://254.169.254.169/latest/meta-data/
- [ ] C. http://192.168.1.1/latest/meta-data/
- [ ] D. http://10.0.0.1/latest/user-data/
...
- [ ] A. They automatically back up your EC2 instances to Amazon S3.
- [ ] B. They allow an instance to be launched in multiple placement groups simultaneously.
- [x] C. They give you control of where interdependent instances run to increase network performance.
- [ ] D. They automatically change the instance type based on utilization.
...
- [ ] A. Amazon EC2 Capacity Blocks for ML
- [x] B. On-Demand Capacity Reservations
- [ ] C. Dedicated Hosts
...
- [ ] A. Automate compute protection.
- [ ] B. Use the minimum amount of hardware.
- [x] C. Select the best pricing model and select the correct resource type, size, and number.
- [ ] D. Control traffic at all layers.
...
- [ ] A. Always use On-Demand instances to prevent over-provisioning.
- [ ] B. Scale the best compute options for your workload.
- [x] C. Use the minimum amount of hardware to meet your needs and use managed services.
- [ ] D. Configure and right-size compute resources.
...
- [x] B. Stop the instance.
- [ ] C. Remove the `config_scripts_user` file immediately.
...
- [x] C. EC2 Instance Savings Plans instance
