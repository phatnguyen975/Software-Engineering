...
Produce the complete `qa-artifacts/summary/README.md` file — the Test Summary Report. All data is extracted from existing artifacts in one batch pass; the human does not need to provide any numbers manually.
...
Write the entire `qa-artifacts/summary/README.md` from scratch. Replace any existing content.
