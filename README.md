...
This repository contains all materials, projects, and notes related to my **Software Engineering (SE)** courses at university. It is organized by subjects to make it easy to track learning progress, store assignments, and manage source code for each course.

## Courses

- [Introduction to Software Engineering](./Introduction-to-SE/README.md)
