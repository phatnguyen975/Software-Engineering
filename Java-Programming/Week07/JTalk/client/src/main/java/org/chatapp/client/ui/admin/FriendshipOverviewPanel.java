...
public class FriendshipOverviewPanel extends JPanel {
    private JTable friendshipTable;
    ...
    public FriendshipOverviewPanel() {
    ...
    private void initControlPanel() {
        ...
        refreshBtn.addActionListener(e -> fetchFriendshipData(currentPage));
    ...
    private void initFriendshipTable() {
        String[] columns = {
                "Username", "Full Name", "Direct Friends", "Network Friends", "Created At"
        };
        ...
        friendshipTable = new JTable(tableModel);
        friendshipTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        friendshipTable.setFont(new Font("Segoe UI", Font.PLAIN, 12));

        JScrollPane scrollPane = new JScrollPane(friendshipTable);
    ...
    private void fetchFriendshipData(int page) {
    ...
    private void reloadPagination() {
        ...
        prevBtn.addActionListener(e -> fetchFriendshipData(currentPage - 1));
        ...
        for (int i = start; i <= end; i++) {
            ...
            int pageNumber = i;
            pageBtn.addActionListener(e -> fetchFriendshipData(pageNumber));
        ...
        nextBtn.addActionListener(e -> fetchFriendshipData(currentPage + 1));
    ...
    public void loadDataLazy() {
        ...
        currentPage = 1;
        fetchFriendshipData(currentPage);
