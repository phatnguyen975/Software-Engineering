...
public class GroupMembersDialog extends BaseDialog {
    private JTable memberTable;
    private DefaultTableModel tableModel;

    public GroupMembersDialog(JFrame parent) {
        super(parent, "Members List", 0.25, 0.4);
    }
    ...
    private void fetchMembersList() {
        ...
        List<String[]> adminsList = generateDummyMembersList();
    ...
    private List<String[]> generateDummyMembersList() {
